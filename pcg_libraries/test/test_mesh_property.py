...
CUBE_FILENAME_PREFIX = os.path.join(rospkg.RosPack().get_path(PKG), 'test', 'meshes', 'cube')
MONKEY_FILENAME_PREFIX = os.path.join(rospkg.RosPack().get_path(PKG), 'test', 'meshes', 'monkey')
...
if __name__ == '__main__':
    import rosunit
    rosunit.unitrun(PKG, 'test_simulation_object_properties', TestSimulationObjectProperties)